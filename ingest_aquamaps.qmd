...
```{mermaid}
%%| label: fig-design
%%| fig-cap: "AquaMaps HCAF 0.5° suitability bilinearly interpolated onto the global 0.05° grid via a precomputed weight join"
flowchart LR
  am["am.duckdb<br/>HCAF 0.5° spp_cells"] --> w05["w05 weight table<br/>(cell_id → 4 loiczid, bilinear w)"]
  w05 --> interp["per-species DuckDB join<br/>Σ w×prob×100, ≥ threshold"]
  interp --> pq[("dist/dataset=am/{sp_key}.parquet<br/>(mdl_key, cell_id, val) · V2/zstd")]
