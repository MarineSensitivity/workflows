...
- **AquaX** (`ax`, raster, v9) → COGs are built + uploaded by `ingest_aquax.qmd` (native ==
  model grid); this notebook only **registers** them (both representations) from `model_ax.csv`.
