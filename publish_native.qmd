...
# per-input-model asset rows across BOTH representations:
#   original/native  = vector PMTiles (source polygons) + am native 0.5° COGs
#   model/interpolated = am 0.05° resampled COGs (+ vector 0.05° gridded COGs if enabled)
# each keyed on the STABLE mdl_key; the `representation` column distinguishes them.
