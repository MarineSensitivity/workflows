...
fig <- plot_ly(
  ...
  layout(
    title = 'Species and Genus Counts by Component',
...
write_csv(
  hierarchy_df,
  paste0(
    "/mnt/user-data/outputs/processed_taxonomy_",
    taxonomy_source,
    "_",
    Sys.Date(),
    ".csv"
...
cat("✅ Processed data saved to outputs directory\n")
cat("📊 Total species processed:", nrow(hierarchy_df), "\n")
cat("🌿 Unique genera:", n_distinct(hierarchy_df$genus), "\n")
cat(
  "🔍 Components included:",
  paste(unique(hierarchy_df$component), collapse = ", ")
)
```
