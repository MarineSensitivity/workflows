...
# FWS STATUS_ABB -> ESA code (the v7 mapping); value via compute_er_score (never hard-coded)
...
for (i in seq_len(nrow(todo))) {
  ...
  write_parquet(tibble(mdl_key = r$mdl_key, cell_id = d$cell_id, value = d$value),
