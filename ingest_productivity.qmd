...
pp_csv      <- glue("{dir_figs}/planarea_primprod.csv")
...
# Rendered to a static PNG rather than a live widget (as the VGPM map above
# already does): this embedded ~25 MB of GeoJSON. See msens::widget_png().
knitr::include_graphics(msens::widget_png(
  mapView(pa_oa) |> slot("map"), "figures/ingest_productivity_pa_oa.png"))
...
# Static PNG: this planning-areas choropleth embedded ~22 MB. See msens::widget_png().
m_pa_npp <- (mapView(
    pa_npp, zcol = "npp_avg", 
...
knitr::include_graphics(msens::widget_png(
  m_pa_npp, "figures/ingest_productivity_pa_npp.png"))
