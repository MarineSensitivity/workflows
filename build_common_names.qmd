...
write_json(list(target = "build_common_names", ver = ver,
  n_taxa = nrow(tx), n_common = sum(!is.na(tx$common_name)),
  by_source = as.list(setNames(src_tbl$n, src_tbl$common_src)),
  n_uncovered = sum(is.na(tx$common_name)), built = as.character(Sys.time())),
