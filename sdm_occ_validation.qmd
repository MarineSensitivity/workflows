...
maplibre(
  ...
  add_fill_layer(
    ...
    popup = paste0(
      ...
      ply_h3_walrus$h3_cell,
      "<br/>",
      "<strong>Records:</strong> ",
      ply_h3_walrus$records,
      "<br/>",
      "<strong>Min Year:</strong> ",
      ply_h3_walrus$min_year,
      "<br/>",
      "<strong>Max Year:</strong> ",
      ply_h3_walrus$max_year,
      "<br/>",
      "<strong>Source OBIS:</strong> ",
      ply_h3_walrus$source_obis,
      "<br/>",
      "<strong>Source GBIF:</strong> ",
      ply_h3_walrus$source_gbif
    )
  ) |>
