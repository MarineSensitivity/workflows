...
if (!dbExistsTable(con_sdm, "ply_planareas")) {
  ...
  # dbExecute(con_sdm, "CREATE INDEX idx_ply_planareas_geom ON ply_planareas(geom)")
  # key size of 313193 bytes exceeds the maximum size of 122880 bytes for this ART
