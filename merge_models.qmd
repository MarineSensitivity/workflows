...
for (col_sql in c(
  ...
  "ALTER TABLE taxon ADD COLUMN IF NOT EXISTS er_score DOUBLE",
...
if (dbExistsTable(con_sdm, "listing")) {
  ...
  n_us <- dbGetQuery(con_sdm,
    "SELECT count(*) AS n FROM taxon WHERE extrisk_code IS NOT NULL")$n
  message(glue("Listing joined: {n_us} taxa with US extrisk_code"))
} else {
