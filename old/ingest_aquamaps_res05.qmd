...
msens:
  ...
  dependency: [ingest_taxon, build_cell_grid]
  output: data/manifests/ingest_aquamaps.json
  dataset: {ds_key: am_0.05, response_type: suitability, source_authority: AquaMaps, temporal_interval: static, native_format: raster}
editor_options:
...
```{r}
#| label: planareas_2025

pa_geo <- glue("{dir_data}/derived/pa_oa_2025.geojson") # created in: ingest_productivity.qmd
# tbl_pa <- Id(schema = "public", table = "ply_planareas_2025")
tbl_pa <- "ply_planareas_2025"

# ply_pa_0 <- st_read(pa_geo)
# st_bbox(ply_pa_0) |> 
#   st_as_sfc() |>
#   st_as_sf() |>
#   st_centroid() |> 
...
if (!tbl_pa %in% dbListTables(con)){
  st_write(ply_pa, con, tbl_pa, delete_layer = T)
  
  # enforce SRID so shows up in tile.marinesensivity.org
  dbExecute(con, glue(
    "SELECT UpdateGeometrySRID('public','ply_planareas_2025','geom',4326);"))
}
...
# SUPERSEDED in v8 by the "Interpolate to H3 hex grid" section below
# (label: v8_hex_ingest). This v7 step bilinear-resampled each species to a
# 0.05-degree COG; v8 interpolates each species' native 0.5-degree suitability
# onto the H3 res-7 hex grid by zero-surround IDW and writes partitioned Parquet.
...
d_spp_pa_tif <- d_spp_pa |> 
  ...
  arrange(n_cells_pa) |>  # ascending order on laptop
  mutate(
...
#
# INFO [2025-05-26 22:24:29] Processing 1  / 17,259: W-Scy-135294
# INFO [2025-05-26 22:26:11] Processing 4  / 17,259: ITS-Mam-612597
# INFO [2025-05-26 22:38:25] Processing 23 / 17,259: Fis-32354
# INFO [2025-05-26 23:07:38] Processing 75 / 17,259: Fis-55519
#
# INFO [2025-05-27 00:20:26] Processing 1 / 17,095: Fis-26569
# INFO [2025-05-27 00:20:26] Processing 2 / 17,095: Fis-28955
# INFO [2025-05-27 00:20:57] Processing 3 / 17,095: Fis-50030
#
# INFO [2025-05-27 00:47:44] Processing  1 / 17,095: Fis-26569
# INFO [2025-05-27 00:47:44] Processing  6 / 17,095: Fis-134025
# INFO [2025-05-27 00:47:55] Processing  7 / 17,095: Fis-149908
# INFO [2025-05-27 00:48:29] Processing  8 / 17,095: Fis-26536
# INFO [2025-05-27 01:16:42] Processing 78 / 17,095: Fis-29879
# INFO [2025-05-27 01:31:29] Processing 118 / 17,095: W-Pol-130324
# INFO [2025-05-27 01:42:07] Processing 148 / 17,095: W-Msc-342293
# 17095 / (148/55) / 60 / 24 = 4.4 days
# INFO [2025-05-27 01:50:36] Processing 169 / 17,095: W-Scl-135209
# INFO [2025-05-27 10:02:22] Processing 2,011 / 17,095: W-Pol-130069
# 
# INFO [2025-05-27 12:10:22] Processing   1 / 14,976: Fis-26569
# INFO [2025-05-27 12:11:00] Processing 150 / 14,976: W-Cop-104298
# INFO [2025-05-27 12:12:34] Processing 158 / 14,976: W-Hyd-290274
# crashed
# INFO [2025-05-27 16:13:06] Processing   1 / 13,867: Fis-26569
# INFO [2025-05-27 16:13:53] Processing 169 / 13,867: W-Bry-111600
# INFO [2025-05-27 16:24:54] Processing 232 / 13,867: Fis-148863

# laptop ----
# INFO [2025-05-27 03:45:04] Processing 1 / 17,070: Fis-113153
# INFO [2025-05-27 03:45:07] Processing 2 / 17,070: Fis-124208
# INFO [2025-05-27 03:46:03] Processing 26 / 17,070: Fis-29441
# INFO [2025-05-27 03:46:05] Processing 27 / 17,070: Fis-32266
# 17070 / 26 / 60  = 10.9 hrs
# INFO [2025-05-27 03:48:03] Processing 72 / 17,070: Chn-58fbf663-c32a-4053-b54d-872ad5bbd716
# 17070 / (72/3) / 60  = 11.8 hrs
# INFO [2025-05-27 03:51:02] Processing 129 / 17,070: Fis-135734
# 17070 / (129/6) / 60  = 13.2 hrs
# INFO [2025-05-27 03:52:04] Processing 148 / 17,070: Fis-144354
# 17070 / (148/7) / 60  = 13.5 hrs
# INFO [2025-05-27 03:53:03] Processing 166 / 17,070: Fis-144796
# 17070 / (166/8) / 60  = 13.7 hrs
# INFO [2025-05-27 03:55:02] Processing 204 / 17,070: Fis-149729
# 17070 / (204/10) / 60  = 13.9 hrs
# INFO [2025-05-27 08:28:05] Processing  5,617 / 17,070: W-Bry-183031
# INFO [2025-05-27 11:31:51] Processing  5,618 / 17,070: W-Msc-140168
# INFO [2025-05-27 12:02:59] Processing  6,281 / 17,070: W-Msc-428255
# INFO [2025-05-27 14:05:46] Processing  8,353 / 17,070: Fis-152142
# INFO [2025-05-27 14:10:26] Processing  8,432 / 17,070: Fis-144140
# INFO [2025-05-27 14:12:56] Processing  8,470 / 17,070: W-Msc-215525
# INFO [2025-05-27 15:17:08] Processing  9,451 / 17,070: W-Ase-378795
# INFO [2025-05-27 18:14:20] Processing 13,427 / 17,070: SLB-27514

# TODO: investigate warnings(): [writeRaster] detected values outside of the limits of datatype INT1U
...
## Interpolate to the global 0.05° cell grid → partitioned Parquet (v8)

The v8 write-target: interpolate each species' native 0.5° AquaMaps suitability
onto the **global 0.05° cell grid** ([-180,180], the `build_cell_grid.qmd` grid),
and write **one Parquet per species** to the marine-atlas release, keyed by
`mdl_key = "am|{sp_key}"`.

Method (**identical to the v7** `iterate`/`resample_smooth` conversion, verified
cor > 0.999): take the native 0.5° raster (`get_species_raster()`, 1-100,
absent = NA, from `am.duckdb` or the cached tif), **zero-fill absent cells within
its extent**, **bilinear-resample onto the 0.05° grid**, mask to ocean, drop values
`< threshold`. No outward margin (bilinear does not extrapolate past the source
extent). `cell_id` is the global raster index (`terra::cellFromXY` on Bio-Oracle) —
the same `cell_id` as the `cell` table. No projection (Bio-Oracle/AquaMaps/AquaX
share the 0.05° topology). The only intended v8 differences from v7 are **global**
extent (no US clip) and the **Parquet** output (vs per-species COG).

**Parallelized with `parallel::mclapply`** (fork-based; ideal on the Linux server)
— forked workers inherit the sourced `get_species_raster()` + attached packages;
each opens its own read-only `am.duckdb` connection, reads rasters from files, and
writes its own Parquet file (no shared writes). **Resumable** — a species whose
Parquet exists is skipped — so it can run over hours on the server and restart
after interruption. (On macOS/Windows, set `n_workers <- 1`; forking + terra is
only reliable on Linux.)

```{r}
#| label: v8_cell_ingest
#| eval: false

librarian::shelf(arrow, DBI, dplyr, duckdb, fs, glue, here, logger,
                 readr, terra, tibble, quiet = T)
source(here("libs/am_functions.R"))   # get_species_raster(), get_hcaf_raster()
source(here("libs/paths.R"))          # ver, sdm_db, dir_big_v, dir_data, bio_oracle_tif, s3_atlas

# --- config -----------------------------------------------------------------
ds_key    <- "am"
dir_am    <- glue("{dir_data}/derived/aquamaps/am.duckdb")            # AquaMaps source db
dir_spp   <- glue("{dir_data}/raw/aquamaps.org/spp_cells")            # cached 0.5° species tifs
dir_dist  <- glue("{dir_big_v}/marine-atlas/dist/dataset={ds_key}")   # local stage; sync to S3 after
threshold <- 1L                                                       # drop suitability < 1
n_workers <- max(1, parallel::detectCores())                          # use all cores
dir_create(dir_dist)

# cell-id COG (single band; cell_id where ocean, NA on land) — the fast ocean
# template + it hands cell_id back directly (no cellFromXY on millions of points).
# Build it first with build_cell_grid.qmd.
stopifnot("run build_cell_grid.qmd first (need cellid_tif)" = file.exists(cellid_tif))

# species list + dataset/model tables (mdl_key = am|{sp_key}); no crosswalk at raw ingest
con_dd  <- dbConnect(duckdb(dir_am, read_only = TRUE))
sp_all  <- tbl(con_dd, "spp") |> select(sp_key, genus, species, iucn_id) |> collect()
dbDisconnect(con_dd, shutdown = TRUE)
sp_all  <- sp_all |>
  mutate(mdl_key = glue("{ds_key}|{sp_key}"),
         taxa    = glue("{genus} {species}"))
write_csv(sp_all |> select(mdl_key, sp_key, taxa, iucn_id),
          glue("{dir_dist}/../model_{ds_key}.csv"))

# per-species interpolation → (cell_id, value); returns TRUE on write, else a reason
interp_sp <- function(sp_key) {
  out_pq <- fs::path(dir_dist, glue("{sp_key}.parquet"))
  if (fs::file_exists(out_pq)) return("skip")

  tif <- fs::path(dir_spp, glue("{sp_key}.tif"))
  r_sp <- if (fs::file_exists(tif)) {
    terra::rast(tif)                                             # cached native 0.5°, 1-100
  } else {
    cdd <- DBI::dbConnect(duckdb::duckdb(dir_am, read_only = TRUE))
    on.exit(DBI::dbDisconnect(cdd, shutdown = TRUE), add = TRUE)
    get_species_raster(sp_key, cdd, get_hcaf_raster(cdd, dir_cache = dir_spp), dir_cache = dir_spp)
  }
  # single-band cell-id raster over the range: cell_id where ocean, NA on land
  r_cell <- terra::crop(terra::rast(cellid_tif), terra::ext(r_sp))

  # v7-identical fade: zero-fill absent cells WITHIN the (trimmed) range extent,
  # bilinear-resample onto the 0.05° grid. No outward margin — bilinear does not
  # extrapolate past the source extent, so this reproduces the v7 iterate/
  # resample_smooth result (verified cor > 0.999). Drop sub-threshold BEFORE
  # extracting so as.data.frame only touches kept cells (a sparse wide-extent
  # species is otherwise ~all zeros — the real slowdown).
  r_sp_z <- r_sp; r_sp_z[is.na(r_sp_z)] <- 0
  r05    <- terra::resample(r_sp_z, r_cell, method = "bilinear")
  r05[r05 < threshold] <- NA

  s <- c(r05, r_cell); names(s) <- c("value", "cell_id")
  d <- terra::as.data.frame(s, na.rm = TRUE)                     # ocean & value>=thr only; cell_id free
  if (nrow(d) == 0) return("empty")

  arrow::write_parquet(tibble(
    mdl_key = glue("{ds_key}|{sp_key}"),
    cell_id = as.integer(d$cell_id),
    value   = round(d$value, 2)), out_pq)
  "done"
}

# run in parallel (fork), resumable. mc.preschedule=FALSE => one fork per species
# (dynamic load-balancing + isolates any single-species crash).
log_info("interpolating {format(nrow(sp_all), big.mark=',')} AquaMaps species on {n_workers} cores (fork) ...")
run1 <- function(k) tryCatch(interp_sp(k), error = function(e) paste0("error: ", conditionMessage(e)))
res <- unlist(parallel::mclapply(sp_all$sp_key, run1,
                                 mc.cores = n_workers, mc.preschedule = FALSE))
print(table(res))

# then sync the release to S3:
#   aws s3 sync {dir_big_v}/marine-atlas s3://oceanmetrics.io-public/marine-atlas/v8
message(glue("done → {dir_dist}  (then: aws s3 sync {dir_big_v}/marine-atlas {s3_atlas}/{ver})"))
```
...
```sh
cd /share/public/cog
ln -s /share/data/raw/aquamaps.org/spp_cells_cog \
      /share/public/cog/sdm/raw/aquamaps
ln -s /share/data//derived/aquamaps.org/spp_cells0.05_cog \
      /share/public/cog/sdm/derived/aquamaps_0.05dd
```
...
url <- "https://file.marinesensitivity.org/cog/sdm/derived/aquamaps_bio-oracle/ITS-Mam-180530.tif"

sp_key <- "Fis-114088"
src    <- "derived/aquamaps_0.05dd"
# src    <- "raw/aquamaps"
url <- glue("https://file.marinesensitivity.org/cog/sdm/{src}/{sp_key}.tif")
# url <- "https://file.marinesensitivity.org/cog/sdm/raw/aquamaps/Fis-114088.tif"
# url <- "https://file.marinesensitivity.org/cog/sdm/raw/aquamaps/Fis-136946.tif"
r <- rast(url)
plet(r)
# terra::summary(r)
...
js_scale = paste0(
  "function (values) {
    var scale = chroma.scale(['white', 'red', 'yellow', '#22c7e8'])
...
pa_url <- "https://tile.marinesensitivity.org/public.sdm_geometries.json"
...
librarian::shelf(
  fs, glue, httr2, mapgl, purrr, stringr, terra)

dir_ds_spp <- glue("{dir_data}/derived/aquamaps.org/spp_cells0.05_cog")

ply_pa

d_tifs <- tibble(
  tif = dir_ls(dir_ds_spp, glob = "*.tif")[1:10] ) |> 
  mutate(
    r = map(
      tif, ~ rast(.x) |> 
        extend(ext(-180, 180, -90, 90))) )
r_all <- rast(d_tifs$r)
names(r_all) <- names(r_all) |> basename() |> path_ext_remove()

r_sum <- sum(r_all, na.rm = T)    # plot(r_sum)
r_sum_pa <- r_sum |> 
  mask(ply_pa, touches = F) |> 
  trim() # plot(r_sum_pa)
rng_sum_pa <- minmax(r_sum_pa) |> as.numeric()
...
# TODO:
# - [ ] Shiny input$MAPID_click https://walker-data.com/mapgl/articles/shiny.html
#   - [ ] /cog/point/{lon},{lat} https://titiler.marinesensitivity.org/api.html#/Cloud%20Optimized%20GeoTIFF/point_cog_point__lon___lat__get
# - [ ] [Building story maps with mapgl • mapgl](https://walker-data.com/mapgl/articles/story-maps.html)
# - [ ] [Getting started with mapgl • mapgl](https://walker-data.com/mapgl/articles/getting-started.html)
