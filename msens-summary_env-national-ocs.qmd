...
d_er_pa_n |> 
  ...
  # row_lbl, region_key, region_name, ecoregion_key, ecoregion_name, row_type, planarea_key, planarea_name, pct_planarea_in_ecoregion, area_km2, score, primprod, sea_turtle, other, mollusk, marine_mammal, fish, crustacean, pct
  ...
  select(
    ...
    row_lbl,
    score,
    primprod, crustacean, fish, marine_mammal, mollusk, sea_turtle, other,
    area_km2) |>
  # View()
...
# DBI::dbListFields(con, "ply_planareas_2025")
d_scores <- tbl(con, "ply_planareas_2025") |> 
  # select(-geom) |>
  # names()
  select(
    planarea_key, 
    planarea_name, 
    score = round(score_extriskspcat_primprod_ecoregionrescaled_equalweights)) |>
  collect()

g <- d |> 
  # filter(planarea_key == "CHU") |> glimpse()
  # mutate(
  #   ecoregion = str_wrap(ecoregion_name, width = 20)) |> 
  # # View()
  ggplot() +
