...
for (theme_name in c("dark")) {
  ...
  theme_fxn <- switch(
    ...
    "min_line"  = function(...){
      ...
      theme(
          ...
          panel.grid.minor = element_line(colour = "black", linewidth = rel(0.05)) )}, 
  ...
  g <- d |> 
    ...
    # FIXED: use max of scores and xmax to ensure all component scores fit
    # Add center score
    geom_text(
      aes(x, y, label = score),
      data = d_scores |> 
