...
# Rendered to a PNG rather than printed as a live widget: this map embedded
# ~40 MB of GeoJSON in the published page. See msens::widget_png().
m_pa <- maplibre(
...
knitr::include_graphics(msens::widget_png(
  m_pa, "figures/show_study-area_planareas.png"))
```
