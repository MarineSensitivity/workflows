...
msens:
  ...
  dependency: [score_zone_metrics]   # terminal score target — transitively covers score_cell_metrics (cell_metric) + score_zones (zone_cell), the two tables this reads
