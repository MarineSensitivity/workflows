...
flowchart LR
  src["IUCN group shapefiles<br/>(24 marine groups)"] --> filt["filter presence∈1:3,<br/>marine=true, category∈OK"]
  filt --> er["val = compute_er_score('IUCN:cat')<br/>CR50 EN25 VU5 NT2 LC/DD1"]
