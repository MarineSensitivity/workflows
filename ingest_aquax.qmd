...
# per-model stats, appended across resumed runs. NOT `model_*.csv`: that glob is the crosswalk
# namespace merge_models_prep and build_registry read, and a stats file there broke both.
stats_csv <- glue("{dir_atlas}/dist/{ds_key}_stats.csv")
