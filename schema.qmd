...
infer_desc <- function(col) {
  known <- c(
    ...
    is_suit = "dataset contains suitability data",
    is_er   = "dataset contains extinction risk data",
...
dataset {
  ...
  INTEGER year_pub
  BOOLEAN is_suit              "suitability layer"
  BOOLEAN is_er                "extinction risk layer"
  BOOLEAN is_mask              "mask layer"
}
model {
