...
```{mermaid}
%%| label: fig-design
%%| fig-cap: "BirdLife BOTW ranges → whole-range extinction-risk value on the global 0.05° grid"
flowchart LR
  src["BOTW gpkg<br/>all_species (presence∈1:3)"] --> chk["join BL/HBW checklist<br/>→ IUCN Red List category"]
  chk --> er["val = compute_er_score('IUCN:code')<br/>CR50 EN25 VU5 NT2 LC/DD1"]
  er --> ee["cells_from_ranges()<br/>exact_extract vs 0.05° cellid COG"]
  ee --> pq[("dist/dataset=bl/{sisid}.parquet<br/>(mdl_key, cell_id, val) · V2/zstd")]
