...
tibble(
  ...
  time     = time(r),
  source   = basename(sources(r)))
#    lyr              longname                         time               
#    <chr>            <chr>                            <dttm>             
# 1  bathymetry_mean Bathymetry Mean                  1970-01-01 00:00:00
# 2  bathymetry_min  Bathymetry Min                   1970-01-01 00:00:00
# 3  bathymetry_max  Bathymetry Max                   1970-01-01 00:00:00
# 4  o2_mean         Average DissolvedMolecularOxygen 2010-01-01 00:00:00
# 5  phyc_mean       Average TotalPhytoplankton       2010-01-01 00:00:00
# 6  siconc_mean     Average SeaIceCover              2010-01-01 00:00:00
# 7  so_mean         Average Salinity                 2010-01-01 00:00:00
# 8  so_mean         Average Salinity                 2010-01-01 00:00:00
# 9  thetao_mean     Average OceanTemperature         2010-01-01 00:00:00
# 10 thetao_mean     Average OceanTemperature         2010-01-01 00:00:00
...
| AquaMaps Variable | AquaMaps Layer | Bio-Oracle v3 Dataset | Bio-Oracle v3 Variable |
|-------------------|----------------|------------------------|------------------------|
| depth (min)       | depth_min      | terrain_characteristics | bathymetry_min |
| depth (mean)      | depth_mean     | terrain_characteristics | bathymetry_mean |
| depth (max)       | depth_max      | terrain_characteristics | bathymetry_max |
| temp (surface)    | sst_an_mean    | thetao_baseline_2000-2019_depthsurf | thetao_mean |
| temp (bottom)     | sbt_an_mean    | thetao_baseline_2000-2019_depthmax | thetao_mean |
| salinity (surface)| salinity_mean  | so_baseline_2000-2019_depthsurf | so_mean |
| salinity (bottom) | salinity_b_mean| so_baseline_2000-2019_depthmax | so_mean |
| oxygen (bottom)   | oxy_b_mean     | o2_baseline_2000-2018_depthmax | o2_mean |
| primary production| prim_prod_mean | phyc_baseline_2000-2020_depthsurf | phyc_mean |
| ice concentration | ice_con_ann    | siconc_baseline_2000-2020_depthsurf | siconc_mean |
...
# Get species information
sp_info <- get_sp_info(sp_key_test, con_dd)
